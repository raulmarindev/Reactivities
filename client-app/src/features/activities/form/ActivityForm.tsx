...
export const ActivityForm: React.FC<IProps> = ({ activity: initialActivity, setEditMode }) => {
    ...
    return (
        <Segment clearing>
            <Form onSubmit={handleSubmit}>
                ...
                <Form.Input name='date' value={activity.date} placeholder='Date' type='date' onChange={handleInputChange} />
